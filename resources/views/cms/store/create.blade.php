...
@section('title', 'إضافة متجر جديد | متجر رونق')
@section('main-title', 'إدارة المتاجر')
@section('sub-title', 'إضافة متجر جديد ضمن منصة متجر رونق')
                    ...
                    <div class="card custom-form-card border-0">
                        ...
                        <div class="form-header d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h5 class="fw-bold mb-1" style="color: var(--rawnaq-dark-title);">إضافة متجر جديد</h5>
                                    <small class="text-muted">تسجيل بيانات المتجر الجديد وربطه بالمالك والعنوان في متجر رونق</small>
                                </div>
                            </div>
                        ...
                        <!-- Form -->
                        <form id="create_store_form" enctype="multipart/form-data">
                            @csrf
                            <div class="p-4">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="text" name="name" id="name" class="form-control"
                                                    placeholder="مثال: بوتيك رونق للأزياء" value="{{ old('name') }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <label for="slug" class="custom-label">
                                                ...
                                                <span class="badge-opt">اختياري / يُولد تلقائياً</span>
                                            </label>
                                            <div class="input-group input-group-custom">
                                                <span class="input-group-text"><i class="bi bi-link-45deg"></i></span>
                                                <input type="text" name="slug" id="slug"
                                                    class="form-control ltr-input" placeholder="rounaq-boutique"
                                                    value="{{ old('slug') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <textarea name="description" id="description" class="form-control" rows="3"
                                                    placeholder="اكتب نبذة تعريفية مختصرة عن المتجر وما يقدمه...">{{ old('description') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <label for="logo" class="custom-label">
                                                ...
                                                <span class="badge-opt">اختر من الجهاز</span>
                                            </label>
                                            <div class="input-group input-group-custom">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <select name="user_id" id="user_id" class="form-select" required>
                                                    <option value="" disabled selected>اختر المالك...</option>
                                                ...
                                                <select name="address_id" id="address_id" class="form-select" required>
                                                    ...
                                                    @foreach ($addresses ?? [] as $address)
                                                        <option value="{{ $address->id }}" {{ old('address_id') == $address->id ? 'selected' : '' }}>
                                                            {{ $address->street }} - {{ $address->city->name ?? '' }} ({{ $address->area }})
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <select name="status" id="status" class="form-select" required>
                                                    <option value="active" {{ old('status') == 'active' ? 'selected' : '' }}>نشط (مفعل)</option>
                                                    <option value="inactive" {{ old('status') == 'inactive' ? 'selected' : '' }}>غير نشط (معطل)</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
...
@section('scripts')
    <script>
        function performStore() {
            ...
            // جلب ملف الشعار إذا تم اختياره
            let logoInput = document.getElementById('logo');
            if (logoInput.files[0]) {
                formData.append('logo', logoInput.files[0]);
            }

            // جلب ملف صورة الغلاف إذا تم اختيارها
            ...
            axios.post('/cms/admin/stores', formData, {
                headers: {
            ...
            .catch(function(error) {
                let message = 'حدث خطأ أثناء إضافة المتجر';
