...
@section('title', 'تفاصيل المنتج | متجر رونق')
@section('main-title', 'المنتجات')
@section('sub-title', 'عرض تفاصيل ومعلومات المنتج المختار ضمن منصة رونق')
                    ...
                    <div class="card custom-show-card border-0">
                        ...
                        <div class="show-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h5 class="fw-bold mb-1" style="color: var(--rawnaq-dark-title);">تفاصيل المنتج: {{ $product->name }}</h5>
                                    <small class="text-muted">رقم التعريف: #{{ $product->id }}</small>
                                </div>
                            </div>
                            <div>
                                <a href="{{ route('products.index') }}" class="btn-return-custom">
                        ...
                        <div class="p-4">
                            <div class="row g-4">
                                ...
                                <div class="col-12 text-center mb-2">
                                    <img src="{{ $product->main_image ? asset('storage/' . $product->main_image) : asset('images/default.png') }}"
                                        alt="صورة المنتج" class="product-show-img">
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="info-box">
                                        <div class="info-label">
                                            <i class="bi bi-upc text-danger fs-5"></i>
                                            <span>رمز المنتج (SKU)</span>
                                        </div>
                                        <div class="info-value">
                                            <code class="text-purple bg-light px-2 py-1 rounded" dir="ltr" style="display: inline-block;">{{ $product->sku }}</code>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="info-box">
                                        ...
                                        <div class="info-value text-danger">{{ $product->base_price }} $</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="info-box">
                                        <div class="info-label">
                                            <i class="bi bi-stack text-danger fs-5"></i>
                                            <span>كمية المخزون</span>
                                        </div>
                                        <div class="info-value">{{ $product->stock_quantity }} قطعة</div>
                                    </div>
                                </div>
                                    ...
                                    <div class="info-box">
                                        ...
                                        <div class="info-value">
                                            @if ($product->is_active === 'active')
                                                <span class="badge bg-success text-white px-3 py-2 rounded-pill fw-bold">نشط</span>
                                            @else
                                                <span class="badge bg-danger text-white px-3 py-2 rounded-pill fw-bold">غير نشط</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="info-box">
                                        ...
                                        <div class="product-desc-box">
                                            {{ $product->description ?? 'لا يوجد وصف تفصيلي لهذا المنتج.' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-footer bg-white border-top p-4 d-flex justify-content-end">
                            <a href="{{ route('products.edit', $product->id) }}" class="btn-edit-custom">
