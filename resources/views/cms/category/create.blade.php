...
@section('title', 'إنشاء تصنيف جديد | متجر رونق')
@section('main-title', 'التصنيفات')
@section('sub-title', 'إضافة وتسجيل تصنيف جديد ضمن أقسام منصة رونق')
                    ...
                    <div class="card custom-form-card border-0">
                        ...
                        <div class="form-header d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h5 class="fw-bold mb-1" style="color: var(--rawnaq-dark-title);">إنشاء تصنيف جديد</h5>
                                    <small class="text-muted">إضافة قسم أو تصنيف جديد لتنظيم المنتجات</small>
                                </div>
                            </div>
                        ...
                        <form id="create_category_form">
                            ...
                            <div class="p-4">
                                <div class="section-box">
                                    <div class="section-badge">
                                        ...
                                        <span>بيانات التصنيف الأساسية</span>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="text" name="name" id="name" class="form-control"
                                                    placeholder="مثال: ملابس نسائية" required>
                                            </div>
                                        </div>

                                        <!-- Type -->
                                        <div class="col-md-6">
                                            <label for="type" class="custom-label">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="text" name="type" id="type" class="form-control"
                                                    placeholder="مثال: products أو stores" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-footer d-flex justify-content-end align-items-center gap-3">
                                <a href="{{ route('categories.index') }}" class="btn-cancel-custom">إلغاء الأمر</a>
                                <button type="button" onclick="performStoreCategory()"
        ...
        function performStoreCategory() {
            ...
            axios.post('/cms/admin/categories', formData)
                ...
                .catch(function(error) {
                    let message = 'حدث خطأ أثناء حفظ التصنيف';
