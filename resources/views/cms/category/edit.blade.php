...
@section('title', 'تعديل التصنيف | متجر رونق')
@section('main-title', 'التصنيفات')
@section('sub-title', 'تحديث وتعديل بيانات التصنيف المحدد ضمن منصة رونق')
                    ...
                    <div class="card custom-form-card border-0">
                        ...
                        <div class="form-header d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h5 class="fw-bold mb-1" style="color: var(--rawnaq-dark-title);">تعديل التصنيف:
                                        {{ $category->name }}</h5>
                                    <small class="text-muted">تحديث معلومات وبيانات التصنيف الحالي</small>
                                </div>
                            </div>
                        ...
                        <form id="update_category_form">
                            ...
                            <div class="form-footer d-flex justify-content-end align-items-center gap-3">
                                ...
                                <button type="button" onclick="performUpdateCategory({{ $category->id }})"
...
@section('scripts')
    <script>
        function performUpdateCategory(id) {
            let formData = {
            ...
            axios.put('/cms/admin/categories/' + id, formData)
                ...
                .catch(function(error) {
                    let message = 'حدث خطأ أثناء تحديث التصنيف';
