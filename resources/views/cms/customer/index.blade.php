...
@section('main_title', 'الزبائن')
@section('sub_title', 'عرض قائمة الزبائن')

@section('styles')
    <!-- خط Cairo وأيقونات Bootstrap -->
...
@section('content')
<div class="customer-container py-4" dir="rtl">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right; padding-right: 1.5rem;">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                @else
                                                    <div class="user-avatar-female"><i class="bi bi-person"></i></div>
                                                @endif
                                        ...
                                        <td>
                                            <div class="d-flex flex-column align-items-center gap-1">
                                                ...
                                                <span class="text-dark small fw-semibold d-inline-flex align-items-center gap-1" style="direction: ltr;">
                                                    {{ $item->phone ?? '-' }}
                                        ...
                                        <!-- ID Number -->
                                        <td>
                                            @if(optional($item->actor)->id_number)
                                                <span class="id-badge">
                                                    {{ $item->actor->id_number }}
                                        ...
                                        <!-- WhatsApp Number -->
                                        <td>
                                            @if(optional($item->actor)->whats_up_number)
                                                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $item->actor->whats_up_number) }}" 
                                                   target="_blank" 
                                                   class="whatsapp-link" 
                                                   title="مراسلة عبر واتساب">
                                                    <span>{{ $item->actor->whats_up_number }}</span>
                                        ...
                                        <td>
                                            <span class="location-badge">
                                                {{ $item->address->street ?? '' }} - {{ $item->address->city->name ?? 'غزة' }}
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="text-center py-5 text-muted">
                                            ...
                                            <span class="fw-semibold">لا يوجد زبائن مضافين حالياً.</span>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
