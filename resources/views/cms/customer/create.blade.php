                    ...
                    <div class="card custom-form-card border-0">
                        ...
                        <div class="form-header d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h5 class="fw-bold mb-1" style="color: var(--rawnaq-dark-title);">إضافة زبون جديد</h5>
                                    <small class="text-muted">تسجيل بيانات العميل ومعلومات التوصيل والاتصال في متجر
                                        رونق</small>
                                </div>
                            </div>
...
@section('scripts')
    <script>
        function performStore() {
            ...
            axios.post('/cms/admin/customers', formData)
                .then(function(response) {
                    ...
                    // التوجيه الفوري والمضمون لقائمة الزبائن
                    setTimeout(function() {
                        window.location.href = "{{ route('customers.index') }}";
                    }, 1200);
                })
                .catch(function(error) {
                    let message = 'حدث خطأ أثناء إضافة الزبون';
