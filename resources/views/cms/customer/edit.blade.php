                ...
                <div class="card custom-form-card border-0">
                    ...
                    <div class="form-header px-4 py-3 d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h5 class="fw-bold mb-0 text-dark">تعديل بيانات الزبون</h5>
                                <small class="text-muted">تحديث البيانات الشخصية ومعلومات الاتصال للزبون</small>
                            </div>
                        </div>
                    ...
                    <form id="edit_customer_form">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-custom">
                                        ...
                                        <input type="text" name="id_number" id="id_number" class="form-control" 
                                            value="{{ optional($customers->actor)->id_number }}" placeholder="مثال: 401xxxxxx" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-custom">
                                        ...
                                        <input type="email" name="email" id="email" class="form-control" 
                                            value="{{ $customers->email }}" placeholder="example@domain.com" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group input-group-custom">
                                        ...
                                        <input type="text" name="phone" id="phone" class="form-control" 
                                            value="{{ $customers->phone }}" placeholder="059xxxxxxx" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group input-group-custom">
                                        ...
                                        <input type="text" name="whats_up_number" id="whats_up_number" class="form-control" 
                                            value="{{ optional($customers->actor)->whats_up_number }}" placeholder="059xxxxxxx" required>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="input-group input-group-custom">
                                        ...
                                        <select name="address_id" id="address_id" class="form-select" required>
                                            ...
                                            @foreach ($address as $item)
                                                <option value="{{ $item->id }}" @selected($item->id == $customers->address_id)>
                        ...
                        <div class="form-footer px-4 py-3 d-flex justify-content-end align-items-center gap-2">
                            ...
                            <button type="button" onclick="performUpdate({{ $customers->id }})" class="btn-save-custom d-flex align-items-center gap-2">
