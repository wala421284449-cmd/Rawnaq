...
@section('title', 'تعديل العرض | متجر رونق')
@section('main-title', 'العروض والتخفيضات')
@section('sub-title', 'تحديث وتعديل بيانات العرض الترويجي المحدد')
                    ...
                    <div class="card custom-form-card border-0">
                        ...
                        <div class="form-header d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h5 class="fw-bold mb-1" style="color: var(--rawnaq-dark-title);">تعديل العرض:
                                        {{ $offer->title }}</h5>
                                    <small class="text-muted">تحديث وتعديل بيانات العرض الترويجي الحالي</small>
                                </div>
                            </div>
                        ...
                        <form id="update_offer_form">
                                                ...
                                                <select name="stores_id" id="stores_id" class="form-select" required>
                                                    ...
                                                    @foreach ($stores ?? [] as $store)
                                                        <option value="{{ $store->id }}"
                                                            {{ $offer->stores_id == $store->id ? 'selected' : '' }}>
                                                            {{ $store->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select name="products_id" id="products_id" class="form-select" required>
                                                    ...
                                                    @foreach ($products ?? [] as $product)
                                                        <option value="{{ $product->id }}"
                                                            {{ $offer->products_id == $product->id ? 'selected' : '' }}>
                                                            {{ $product->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="text" name="discount_percentage" id="discount_percentage"
                                                    class="form-control" value="{{ $offer->discount_percentage }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="text" name="sale_price" id="sale_price" class="form-control"
                                                    value="{{ $offer->sale_price }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="date" name="end_date" id="end_date"
                                                    class="form-control" value="{{ $offer->end_date }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <select name="is_active" id="is_active" class="form-select" required>
                                                    <option value="active"
                                                        {{ $offer->is_active === 'active' ? 'selected' : '' }}>نشط</option>
                                                    <option value="inactive"
                                                        {{ $offer->is_active === 'inactive' ? 'selected' : '' }}>غير نشط
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="form-footer d-flex justify-content-end align-items-center gap-3">
                                ...
                                <button type="button" onclick="performUpdateOffer({{ $offer->id }})"
...
@section('scripts')
    <script>
        function performUpdateOffer(id) {
            let formData = {
            ...
            axios.put('/cms/admin/offers/' + id, formData)
                ...
                .catch(function(error) {
                    let message = 'حدث خطأ أثناء تحديث العرض';
