...
@section('title', 'إضافة تقييم جديد | متجر رونق')
@section('main-title', 'التقييمات والآراء')
@section('sub-title', 'تسجيل تقييم جديد لمنتج أو طلب بالنيابة عن العميل')
                    ...
                    <div class="card custom-form-card border-0">
                        <div class="form-header d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h5 class="fw-bold mb-1" style="color: var(--rawnaq-dark-title);">إضافة تقييم جديد</h5>
                                    <small class="text-muted">تسجيل تقييم وتعليق جديد لمنتج ضمن النظام</small>
                                </div>
                            </div>
                        ...
                        <form id="create_review_form">
                            @csrf
                            <div class="p-4">
                                <div class="section-box">
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <label class="custom-label">المستخدم (صاحب التقييم)</label>
                                        ...
                                        <div class="col-md-4">
                                            <label class="custom-label">المنتج المتقيّم</label>
                                            <div class="input-group input-group-custom">
                                        ...
                                        <div class="col-md-4">
                                            <label class="custom-label">الطلب المرتبط</label>
                                            <div class="input-group input-group-custom">
                                                <span class="input-group-text"><i class="bi bi-receipt"></i></span>
                                                <select name="orders_id" id="orders_id" class="form-select" required>
                                                    <option value="" disabled selected>اختر الطلب...</option>
                                                    @foreach ($orders ?? [] as $order)
                                                        <option value="{{ $order->id }}">طلب #{{ $order->id }}
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="text" name="comment" id="comment" class="form-control"
                                                    placeholder="اكتب تعليق العميل هنا..." required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-footer d-flex justify-content-end align-items-center gap-3">
                                ...
                                <button type="button" onclick="performStoreReview()" class="btn-save-custom">حفظ
                                    التقييم</button>
                            </div>
                        </form>
                    </div>
...
@section('scripts')
    <script>
        function performStoreReview() {
            ...
            axios.post('/cms/admin/reviews', formData)
