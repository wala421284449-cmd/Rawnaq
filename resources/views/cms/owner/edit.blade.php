@extends('parent')
@section('title', 'تعديل بيانات المالك | متجر رونق')
                    ...
                    <div class="card card-custom" dir="rtl">
                        ...
                        <div class="card-header bg-white py-3 px-4 border-bottom d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <h5 class="card-title fw-bold m-0 text-dark">تعديل بيانات المالك: {{ $owner->name }}</h5>
                            </div>
                        ...
                        <form id="edit-owner-form">
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="email" name="email" id="email" class="form-control ltr-input"
                                                placeholder="owner@rawnaq.com" value="{{ $owner->email }}" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" name="password" id="password" class="form-control ltr-input"
                                                placeholder="اتركها فارغة إن لم ترغب في التغيير" autocomplete="new-password" />
                                        </div>
                                        <div class="field-hint">اترك الحقل فارغاً في حال الرغبة بالاحتفاظ بكلمة المرور الحالية</div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="id_number" id="id_number" class="form-control ltr-input"
                                                placeholder="40xxxxxxx" value="{{ $owner->id_number ?? ($owner->actor?->id_number ?? '') }}" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel" name="phone" id="phone" class="form-control ltr-input"
                                                placeholder="059xxxxxxx" value="{{ $owner->phone }}" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel" name="whats_up_number" id="whats_up_number" class="form-control ltr-input"
                                                placeholder="059xxxxxxx" value="{{ $owner->whats_up_number ?? ($owner->actor?->whats_up_number ?? '') }}" required />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="status" id="status" class="form-select" required>
                                                ...
                                                <option value="active" @selected($owner->status == 'active' || $owner->status == 1)>نشط</option>
                                                <option value="inactive" @selected($owner->status == 'inactive' || $owner->status == 0)>غير نشط</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer bg-light px-4 py-3 d-flex align-items-center justify-content-end gap-2">
                                ...
                                <button type="button" onclick="performUpdate({{ $owner->id }})" class="btn btn-primary px-4 shadow-sm">
...
@section('scripts')
    <script>
        function performUpdate(id) {
            ...
            update('/cms/admin/owners/' + id, data, '/cms/admin/owners');
        }
    </script>
@endsection
