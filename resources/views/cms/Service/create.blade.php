...
@section('title', 'إنشاء خدمة جديدة | متجر رونق')
@section('main-title', 'الخدمات')
@section('sub-title', 'إضافة وتسجيل خدمة جديدة وإدارتها ضمن منصة رونق')
                    ...
                    <div class="card custom-form-card border-0">
                        ...
                        <div class="form-header d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h5 class="fw-bold mb-1" style="color: var(--rawnaq-dark-title);">إنشاء خدمة جديدة</h5>
                                    <small class="text-muted">إضافة وتحديد بيانات الخدمة والأسعار التابعة للمتجر</small>
                                </div>
                            </div>
                        ...
                        <form id="create_service_form">
                            ...
                            <div class="p-4">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="text" name="name" id="name" class="form-control" placeholder="مثال: تنظيف بشرة ملكي" required>
                                            </div>
                                        </div>
                                ...
                                <!-- Section 2: تفاصيل التسعير والتوفر -->
                                <div class="section-box">
                                    <div class="section-badge">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="text" name="price" id="price" class="form-control" placeholder="50" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="text" name="duration_minutes" id="duration_minutes" class="form-control" placeholder="30" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <select name="is_available" id="is_available" class="form-select" required>
                                                    <option value="available" selected>متوفرة</option>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group input-group-custom align-items-start">
                                                ...
                                                <textarea name="description" id="description" class="form-control" rows="3" placeholder="اكتب تفاصيل أو وصف الخدمة هنا..."></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-footer d-flex justify-content-end align-items-center gap-3">
                                ...
                                <button type="button" onclick="performStoreService()" class="btn-save-custom d-flex align-items-center gap-2">
        ...
        function performStoreService() {
            ...
            axios.post('/cms/admin/services', formData)
                ...
                .catch(function(error) {
                    let message = 'حدث خطأ أثناء حفظ الخدمة';
