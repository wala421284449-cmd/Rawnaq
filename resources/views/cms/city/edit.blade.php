@extends('parent')
@section('title', 'تعديل مدينة: ' . $cities->name . ' | متجر رونق')
@section('main-title', 'إدارة المدن')
@section('sub-title', 'تعديل بيانات وتفاصيل المدينة')
                    ...
                    <div class="card custom-form-card border-0">
                        ...
                        <div class="form-header d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h5 class="fw-bold mb-1" style="color: var(--rawnaq-dark-title);">تعديل مدينة:
                                        {{ $cities->name }}</h5>
                                    <small class="text-muted">تحديث بيانات واسم وحالة المدينة في متجر رونق</small>
                                </div>
                            </div>
                            ...
                            <div class="p-4">
                                ...
                                <div class="section-box">
                                    <div class="section-badge">
                                        ...
                                        <span>تحديث بيانات المدينة</span>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-custom">
                                            ...
                                            <input type="text" name="slug" id="slug"
                                                class="form-control ltr-input" placeholder="gaza-city"
                                                value="{{ $cities->slug }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-custom">
                                            ...
                                            <select name="is_active" id="is_active" class="form-select" required>
                                                ...
                                                <option value="active"
                                                    {{ $cities->is_active === 'active' || $cities->is_active == 1 ? 'selected' : '' }}>
                                                    مفعل (Active)
                                                </option>
                                                <option value="inactive"
                                                    {{ $cities->is_active === 'inactive' || $cities->is_active == 0 ? 'selected' : '' }}>
                                                    غير مفعل (Inactive)
                                                </option>
                                            </select>
                                        </div>
...
@section('scripts')
    <script>
        function performUpdate(id) {
            ...
            axios.post('/cms/admin/cities/' + id, formData)
                ...
                .catch(function(error) {
                    let message = 'حدث خطأ أثناء تحديث بيانات المدينة';
