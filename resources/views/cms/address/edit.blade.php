@extends('parent')
@section('title', 'تعديل عنوان | متجر رونق')
@section('main-title', 'إدارة العناوين')
@section('sub-title', 'تعديل بيانات العنوان والموقع الجغرافي')
                    ...
                    <div class="card custom-form-card border-0">
                        ...
                        <div class="form-header d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h5 class="fw-bold mb-1" style="color: var(--rawnaq-dark-title);">تعديل العنوان
                                        #{{ $address->id }}</h5>
                                    <small class="text-muted">تحديث تفاصيل المنطقة، الشارع، والإحداثيات الجغرافية في نظام
                                        رونق</small>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="text" name="area" id="area" class="form-control"
                                                    value="{{ $address->area }}" placeholder="مثال: حي الرمال" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="text" name="street" id="street" class="form-control"
                                                    value="{{ $address->street }}" placeholder="مثال: شارع عمر المختار"
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="text" name="building_details" id="building_details"
                                                    class="form-control" value="{{ $address->building_details }}"
                                                    placeholder="مثال: عمارة القصاص">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <select name="city_id" id="city_id" class="form-select" required>
                                                    <option value="" disabled>اختر المدينة التابع لها العنوان...
                                                    </option>
                                                    @foreach ($cities as $city)
                                                        <option value="{{ $city->id }}" @selected($city->id == $address->city_id)>
                                                            {{ $city->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="text" name="latitude" id="latitude"
                                                    class="form-control ltr-input" value="{{ $address->latitude }}"
                                                    placeholder="مثال: 31.25">
                                            </div>
                                            <div class="field-hint">
                                                <i class="bi bi-info-circle ms-1"></i> قيمة عشرية محصورة بين -90 و 90
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group input-group-custom">
                                                ...
                                                <input type="text" name="longitude" id="longitude"
                                                    class="form-control ltr-input" value="{{ $address->longitude }}"
                                                    placeholder="مثال: 35.2">
                                            </div>
                                            <div class="field-hint">
                                                <i class="bi bi-info-circle ms-1"></i> قيمة عشرية محصورة بين -180 و 180
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@section('scripts')
    <script>
        function performUpdate(id) {
            ...
            axios.put('/cms/admin/addresses/' + id, data)
                ...
                .catch(function(error) {
                    let message = 'حدث خطأ أثناء تعديل العنوان';
