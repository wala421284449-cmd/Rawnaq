@extends('parent')
@section('title', 'قائمة المسميات الوظيفية | متجر رونق')
@section('main-title', 'إدارة المسميات الوظيفية')
@section('sub-title', 'عرض وإدارة الأدوار والصلاحيات في النظام')
...
@section('content')
    <div class="role-wrapper py-3" dir="rtl">
            ...
            <div class="card custom-table-card border-0">
                ...
                <div class="table-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="fw-bold mb-1" style="color: var(--rawnaq-dark-title);">قائمة المسميات الوظيفية</h5>
                            <small class="text-muted">عرض وإدارة الأدوار والصلاحيات المتاحة لمستخدمي ومشرفي متجر
                                رونق</small>
                        </div>
                    </div>
                    @can('Create Role')
                        <a href="{{ route('roles.create') }}" class="btn-create-custom d-flex align-items-center gap-2">
                        ...
                        <table class="table custom-table align-middle">
                            ...
                            <tbody>
                                @forelse ($roles as $role)
                                    <tr>
                                        <td class="text-center fw-bold" style="color: #9333ea;">{{ $role->id }}</td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="guard-badge"
                                                    ...
                                                    <i class="bi bi-lock-fill"></i> {{ $role->guard_name }}
                                                </span>
                                            @endif
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{ route('roles.edit-permissions', $role->id) }}"
                                                    class="badge px-3 py-2 fs-6 text-white fw-bold text-decoration-none"
                                                    style="background: var(--rawnaq-gradient); border-radius: 10px; box-shadow: 0 4px 12px rgba(190, 24, 93, 0.25);">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center py-5 text-muted">
                                            ...
                                            <h6 class="fw-bold text-dark">لا توجد مسميات وظيفية مسجلة حالياً</h6>
                                            <p class="text-muted small mb-0">يمكنك البدء بإضافة مسمى جديد عبر النقر على زر
                                                الإضافة أعلاه.</p>
                                        </td>
                                    </tr>
                                @endforelse
