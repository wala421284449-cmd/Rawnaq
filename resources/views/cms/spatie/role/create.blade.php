@extends('parent')
@section('title', 'إضافة مسمى وظيفي جديد | متجر رونق')
@section('main-title', 'إدارة المسميات الوظيفية')
@section('sub-title', 'إضافة مسمى وظيفي جديد إلى النظام')
                    ...
                    <div class="card custom-form-card border-0">
                        ...
                        <div class="form-header d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h5 class="fw-bold mb-1" style="color: var(--rawnaq-dark-title);">إضافة مسمى وظيفي جديد
                                    </h5>
                                    <small class="text-muted">إدارة وتحديد تفاصيل المسمى الوظيفي والصلاحيات في متجر
                                        رونق</small>
                                </div>
                            </div>
                            <a href="{{ route('roles.index') }}" class="btn-return-custom d-flex align-items-center gap-2">
                        ...
                        <form id="create-role-form">
                            ...
                            <div class="p-4">
                                ...
                                <div class="section-box">
                                    <div class="section-badge">
                                        ...
                                        <span>بيانات المسمى الوظيفي</span>
                                    </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <label for="name" class="custom-label">
                                                <span>اسم المسمى الوظيفي (Role Name)</span>
                                                <span class="badge-req">مطلوب</span>
                                            </label>
                                            <div class="input-group input-group-custom">
                                                <span class="input-group-text"><i class="bi bi-person-badge"></i></span>
                                                <input type="text" name="name" id="name" class="form-control"
                                                    placeholder="مثال: مدير مبيعات، مشرف عام..." required />
                                            </div>
                                        </div>
                            ...
                            <div class="form-footer d-flex justify-content-end align-items-center gap-3">
                                <a href="{{ route('roles.index') }}" class="btn-cancel-custom">إلغاء الأمر</a>
...
@section('scripts')
    <script>
        function performStore() {
            ...
            axios.post('/cms/admin/roles', formData)
                .then(function(response) {
                    ...
                    // التوجيه الفوري والمضمون لصفحة قائمة المسميات الوظيفية الرئيسية
                    setTimeout(function() {
                        window.location.href = "{{ route('roles.index') }}";
                    }, 1200);
                })
                .catch(function(error) {
                    let message = 'حدث خطأ أثناء حفظ المسمى الوظيفي';
