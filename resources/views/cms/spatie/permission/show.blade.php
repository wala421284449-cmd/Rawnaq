@extends('parent')
@section('title', 'تفاصيل الصلاحية: ' . $permission->name . ' | متجر رونق')
@section('main-title', 'إدارة الصلاحيات')
@section('sub-title', 'عرض تفاصيل الصلاحية ونطاق الحراسة في النظام')
...
@section('content')
    <div class="permission-show-wrapper py-3" dir="rtl">
        <div class="container-fluid px-3">

            <!-- Top Action Bar -->
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
                <div>
                    <h4 class="fw-bold mb-1" style="color: var(--rawnaq-dark-title);">الصلاحية: {{ $permission->name }}</h4>
                    <p class="text-muted small mb-0">عرض تفاصيل الصلاحية ونطاق الحراسة المرتبط بها في نظام متجر رونق</p>
                </div>
                <div class="d-flex align-items-center gap-2">
                    <a href="{{ route('permissions.index') }}" class="btn-back-custom d-flex align-items-center gap-2">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-5">
                    <div class="card profile-card p-4 text-center">
                        ...
                        <h5 class="fw-bold text-dark mb-1">{{ $permission->name }}</h5>
                        <p class="text-muted small mb-3">النطاق:
                            ...
                            @elseif ($permission->guard_name == 'owner')
                                <span class="badge px-2 py-1"
                                    ...
                                    (Owner)</span>
                            @else
                                <span class="badge px-2 py-1 bg-light text-secondary">{{ $permission->guard_name }}</span>
                            @endif
                        </p>
                        ...
                        <div class="d-flex justify-content-between align-items-center small mb-3">
                            ...
                            <span class="fw-bold text-dark">#{{ $permission->id }}</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center small mb-3">
                            <span class="text-muted fw-semibold">تاريخ الإنشاء:</span>
                            <span class="fw-bold text-dark">{{ $permission->created_at?->format('Y-m-d') ?? '-' }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="card info-card p-4 mb-4 text-end">
                        <div class="info-card-header">
                            ...
                            <span>معلومات الصلاحية الأساسية</span>
                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <div class="detail-box">
                                    ...
                                    <div>
                                        <div class="field-label">اسم الصلاحية</div>
                                        <div class="field-value">{{ $permission->name }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="detail-box">
                                    ...
                                    <div>
                                        <div class="field-label">نطاق الحراسة (Guard Name)</div>
